    ...
    <div>
      <section className="pt-8 lg:pt-32 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <Link
            to={"/facilities"}
            className="w-full md:w-auto mb-14 inline-flex items-center justify-center py-3 px-7 text-base font-semibold text-center  rounded-full bg-button shadow-xs hover:bg-button-dark transition-all duration-500"
          >
            Book Now
            <svg
              className="ml-2"
